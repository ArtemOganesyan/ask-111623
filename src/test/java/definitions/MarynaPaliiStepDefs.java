...
public class MarynaPaliiStepDefs {
    ...
    @Then("MP I wait for element with xpath \"([^\"]*)\" to not be present$")
    ...
    @Then("MP element with xpath \"([^\"]*)\" should be displayed$")
    public void elementWithXpathShouldBeDisplayed(String xpath) {
        assertThat(getDriver().findElement(By.xpath(xpath)).isDisplayed()).isTrue();
    }

    @Then("MP element with xpath \"([^\"]*)\" should not be displayed$")
    ...
    @Then("MP element with xpath \"([^\"]*)\" should be selected$")
    ...
    @Then("MP element with xpath \"([^\"]*)\" should not be selected$")
    ...
    @When("MP I type \"([^\"]*)\" into element with xpath \"([^\"]*)\"$")
    public void iTypeIntoElementWithXpath(String text, String xpath) {
        getDriver().findElement(By.xpath(xpath)).sendKeys(text);
    }

    @Then("MP I click on element with xpath \"([^\"]*)\"$")
    public void iClickOnElementWithXpath(String xpath) {
        getDriver().findElement(By.xpath(xpath)).click();
    }

    @Then("MP I click on element using JavaScript with xpath \"([^\"]*)\"$")
    ...
    @Then("MP element with xpath \"([^\"]*)\" should have attribute \"([^\"]*)\" as \"([^\"]*)\"$")
    ...
    @Then("MP element with xpath \"([^\"]*)\" should not have attribute \"([^\"]*)\" as \"([^\"]*)\"$")
    ...
    @When("MP I mouse over element with xpath \"([^\"]*)\"$")
    ...
    public void mpILoggedInAsATeacher() {
    }

    @Then("MP I verify account name {string} and account role {string} is displayed")
    public void mpIVerifyAccountNameAndRoleIsDisplayed(String accountnametext, String accountroletext) {
    }

    @Then("MP I scroll to the element with xpath {string}")
    public void mpIScrollToTheElementWithXpath(String arg0) {
    }

    @Then("MP I wait for element with xpath {string} to be displayed")
    public void mpIWaitForElementWithXpathToBeDisplayed(String arg0) {
